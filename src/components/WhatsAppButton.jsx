...
const WhatsAppButton = ({ phoneNumber, message }) => {
  ...
  return (
    <a
      ...
      className=" hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full inline-flex items-center"
    >
      <svg xmlns="http://www.w3.org/2000/svg" className='h-12 w-12' x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
